...
public class TreeCommonGroupConnector extends TreeCommonConnector {
	 ...
	 */
	public TreeCommonGroupConnector(Connection db){
	 ...
	 */
	public TreeCommonGroupConnector(Connection db, DBType db_type){
		this(db,db_type, new TreeCommonGroupFactory());
	}
	 ...
	 */
	public TreeCommonGroupConnector(Connection db, DBType db_type, BaseFactory a_factory){
	 ...
	 */
	public TreeCommonGroupConnector(Connection db, DBType db_type, BaseFactory a_factory, RenderStrategy render_type){
